...
d3.csv('data/stacked_area2.csv').then((data) => {
    ...
    // finish configuration of the stack
    stack
        .keys(keys)
        .order(d3.stackOrderNone)
        .offset(d3.stackOffsetNone);

    // bind the data to the stack and create the group
    var stackedSeries = g.selectAll(".stack")
        .data(stack(data))
        .enter()
        .append("g")
        .attr("class", "stack")
    ...
    // call the area generator
    stackedSeries.append("path")
        .attr("d", area);
